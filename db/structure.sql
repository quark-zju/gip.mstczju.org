...
CREATE TABLE "lecturers" ("staff_id" integer NOT NULL, "topic_id" integer NOT NULL, "created_at" DATETIME DEFAULT CURRENT_TIMESTAMP);
CREATE TABLE "listeners" ("staff_id" integer NOT NULL, "topic_id" integer NOT NULL, "created_at" DATETIME DEFAULT CURRENT_TIMESTAMP);
...
CREATE INDEX "index_lecturers_on_created_at" ON "lecturers" ("created_at");
CREATE INDEX "index_listeners_on_created_at" ON "listeners" ("created_at");
