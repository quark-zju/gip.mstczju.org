...
CREATE TABLE "lecturers" ("staff_id" integer NOT NULL, "topic_id" integer NOT NULL);
CREATE TABLE "listeners" ("staff_id" integer NOT NULL, "topic_id" integer NOT NULL);
...
CREATE UNIQUE INDEX "index_lecturers_on_topic_id_and_staff_id" ON "lecturers" ("topic_id", "staff_id");
...
CREATE UNIQUE INDEX "index_listeners_on_topic_id_and_staff_id" ON "listeners" ("topic_id", "staff_id");
